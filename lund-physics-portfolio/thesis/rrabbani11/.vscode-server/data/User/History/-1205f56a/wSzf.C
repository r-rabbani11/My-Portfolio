...
void drawRatiosXiXibar() {
    ...
    hKPlus5->SetTitle("K^{+/-}/(#pi^{+} + #pi^{-}) ratio within #Xi-#bar{Xi} productions (5 bins);Centrality Class;Yield Ratio");
    ...
    // Draw
    TCanvas* c1 = new TCanvas("c1", "K/pi ratio within Xi-Xi-bar (5 bins)", 1700, 1000);
    c1->SetLogy();
    c1->SetGrid();
    hKPlus5->Draw("E1");
