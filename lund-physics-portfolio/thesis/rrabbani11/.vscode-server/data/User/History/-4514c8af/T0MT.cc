...
int main() {
  ...
  // Baryon production
  pythia.readString("StringFragmentation:probQQtoQ = 0.10");
  pythia.readString("StringFragmentation:probQQ1toQQ0join = 0.50,0.50,0.50,0.50");
